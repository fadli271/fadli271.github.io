...
// import { CheckCircle, Zap, Handshake, Phone, Mail } from "lucide-react";
...
//       {/* Hero Section */}
//       <Section className="text-center" id="hero-catalogue">
...
//       {/* Promo Section */}
//       <Section className="bg-emerald-50" id="promo">
...
//             <Card
//               key={pkg.name}
//               className="p-6 h-full flex flex-col bg-white text-gray-800"
//             >
//               <CardHeader>
...
//             <Card className="mt-8 text-center p-6 bg-white">
...
//           <Card className="p-8 text-center bg-white text-gray-800">
...
//       {/* FAQ Section */}
//       <Section className="bg-white text-gray-800" id="faq">
//         <SectionTitle>{faq.title}</SectionTitle>
//         <div className="mt-12 max-w-3xl mx-auto text-gray-800">
//           <Accordion className="text-gray-800" selectionMode="multiple">
  ...
  return (
    <div className="bg-gray-50">
      ...
      <Section className="bg-sky-50" id="promo">
        <div className="bg-white p-8 rounded-2xl text-center border-2 border-dashed border-sky-300 shadow-lg">
          <h2 className="text-3xl font-bold text-sky-700">{promo.title}</h2>
          <p className="mt-2 text-lg font-medium text-gray-600">
            {promo.subtitle}
          </p>
      ...
      <Section id="packages">
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          {packages.items.map((pkg) => (
            <Card
              key={pkg.name}
              className={`p-6 h-full flex flex-col transition-all duration-300 ${pkg.isPopular ? "border-2 border-sky-500 shadow-2xl scale-105" : "shadow-lg"}`}
            >
              {pkg.isPopular && (
                <Chip
      ...
      <div className="bg-white">
        ...
        >
          ...
          <div>
            <SectionTitle>{custom.title}</SectionTitle>
            <SectionSubtitle>{custom.description}</SectionSubtitle>
            <Card className="mt-8 text-center p-6 border-2 border-primary">
              <p className="font-bold text-3xl text-gray-800">{custom.price}</p>
              <p className="mt-4 text-gray-600">
                Contoh Proyek: {custom.examples.join(", ")}.
              </p>
              <p className="mt-4 font-semibold text-sm text-gray-500">
          ...
          <Accordion selectionMode="multiple" variant="splitted">
            {faq.items.map((item, index) => (
              <AccordionItem
                key={index}
                aria-label={item.q}
                title={<span className="font-semibold">{item.q}</span>}
              >
                {item.a}
              </AccordionItem>
            ))}
