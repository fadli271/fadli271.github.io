...
export default function ServiceLandingPage() {
  ...
  const portfolioWithIndex = portfolioItems.map((project, idx) => ({
    project,
    idx,
  }));
  ...
  return (
    <div className="bg-[#f8fafc] text-[#334155] relative dark:bg-gray-950 dark:text-gray-300">
      ...
      <main aria-label="Layanan Fadli Dev Studio">
                ...
                <FadeUp key={item.title} delay={idx * 0.1}>
                  <div className="group bg-gray-50 p-8 rounded-3xl hover:shadow-xl hover:shadow-sky-500/5 hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-sky-500/20 h-full dark:bg-gray-900 dark:hover:shadow-gray-900/50">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed dark:text-gray-400">
                      {whyChooseUsTranslations[idx]?.description ??
                        item.description}
                    </p>
                  </div>
                </FadeUp>
              ...
              {processSteps.map((step, idx) => (
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed px-4 dark:text-gray-400">
                    {processStepTranslations[idx]?.description ??
                      step.description}
                  </p>
                </FadeUp>
              ))}
                ...
                <FadeUp key={service.title} delay={idx * 0.12}>
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 mb-6 min-h-[60px] dark:text-gray-400">
                      {serviceTranslations[idx]?.description ??
                        service.description}
                    </p>
                    <ul className="space-y-3 border-t border-gray-100 pt-6 dark:border-gray-800">
                      {(
                        serviceTranslations[idx]?.features ?? service.features
                      ).map((feat, featIdx) => (
                        <li
                          key={`${feat}-${featIdx}`}
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          {pt.description ?? project.description}
                        </p>
                      </div>
                    </CardWrapper>
                  </FadeUp>
              ...
              {[...testimonials, ...testimonials].map((t, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-4 border-b border-gray-200 pb-4 dark:border-gray-700">
                    <div
                      className={`${t.iconBgClass} p-2 rounded-lg dark:bg-gray-800`}
                    >
                      <MaterialIcon
        ...
        {/* ── Mini Case Study & ROI (Native Template Integration) ── */}
        <section className="py-24 bg-white relative dark:bg-gray-900" id="roi">
          <div className={containerClass}>
            <SlideLeft className="text-center mb-16 max-w-3xl mx-auto">
              <span className="text-sky-500 font-bold tracking-wider text-xs uppercase mb-2 block">
                {lang === "id" ? "Dampak Nyata" : "Real Impact"}
              </span>
              <h2 className="text-3xl font-bold text-gray-900 mb-4 dark:text-white">
                {lang === "id"
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                {lang === "id"
                  ? "Klien tingkat tinggi tidak sekadar mencari estetika; mereka menuntut hasil. Berikut adalah bagaimana strategi kami memberikan return on investment (ROI) instan."
                  : "High-end clients aren't just looking for aesthetics; they demand results. Here is how our digital strategies deliver immediate ROI."}
              </p>
            </SlideLeft>
            ...
            <div className="flex flex-col gap-6 max-w-5xl mx-auto">
              {[
                {
                  klien: lang === "id" ? "Retail & B2B" : "Retail & B2B Corp",
                  sebelum:
                    lang === "id"
                      ? "Katalog manual, miskomunikasi harga, dan order tertumpuk di antrean chat CS."
                      : "Manual catalogs, pricing miscommunication, and orders stuck in chat queues.",
                  sesudah:
                    lang === "id"
                      ? "Katalog digital mobile-first terintegrasi langsung dengan order management otomatis."
                      : "Mobile-first digital catalog integrated directly with automated order management.",
                  roi: "+300%",
                  roiLabel: lang === "id" ? "Kecepatan Order" : "Order Speed",
                  icon: "storefront",
                },
                {
                  klien:
                  ...
                  sebelum:
                    lang === "id"
                      ? "Jadwal staf sering bentrok akibat reservasi yang masih mengandalkan kertas/buku tamu."
                      : "Staff schedules often conflict due to paper-based guestbooks and phone calls.",
                  sesudah:
                    lang === "id"
                      ? "Sistem booking online realtime dilengkapi dengan automasi notifikasi pengingat via WhatsApp."
                      : "Real-time online booking system with automated WhatsApp reminder notifications.",
                  roi: "0%",
                  roiLabel: lang === "id" ? "Double Booking" : "Double Booking",
        ...
        <section className="py-24 bg-gray-50 dark:bg-gray-950" id="harga">
          <div className={containerClass}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <FadeUp className="flex" delay={0.25}>
                <div className="bg-white rounded-3xl p-6 lg:p-8 border border-gray-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group h-full flex flex-col dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-900 dark:hover:shadow-gray-900/50">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2 dark:text-white">
                    {otherServicesTranslations[0]?.title ??
                      "Toko Online / Katalog"}
                  </h3>
                  <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100 dark:text-gray-400 dark:border-gray-700">
                    {otherServicesTranslations[0]?.description ??
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[0]?.features?.[0] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[0]?.features?.[1] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[0]?.features?.[2] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="tune"
                      />
                      {otherServicesTranslations[0]?.features?.[3] ??
              ...
              <FadeUp className="flex" delay={0.3}>
                <div className="bg-white rounded-3xl p-6 lg:p-8 border border-gray-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group h-full flex flex-col dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-900 dark:hover:shadow-gray-900/50">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2 dark:text-white">
                    {otherServicesTranslations[1]?.title ??
                      "Sistem Operasional"}
                  </h3>
                  <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100 dark:text-gray-400 dark:border-gray-700">
                    {otherServicesTranslations[1]?.description ??
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[1]?.features?.[0] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[1]?.features?.[1] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[1]?.features?.[2] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="tune"
                      />
                      {otherServicesTranslations[1]?.features?.[3] ??
              ...
              <FadeUp className="flex" delay={0.35}>
                <div className="bg-white rounded-3xl p-6 lg:p-8 border border-gray-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group h-full flex flex-col dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-900 dark:hover:shadow-gray-900/50">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2 dark:text-white">
                    {otherServicesTranslations[2]?.title ?? "Mobile Apps"}
                  </h3>
                  <p className="text-sm text-gray-500 mb-6 pb-6 border-b border-gray-100 dark:text-gray-400 dark:border-gray-700">
                    {otherServicesTranslations[2]?.description ??
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[2]?.features?.[0] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[2]?.features?.[1] ??
                        "Push notification"}
                    </li>
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="check_circle"
                      />
                      {otherServicesTranslations[2]?.features?.[2] ??
                    ...
                    <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                      <MaterialIcon
                        ...
                        name="tune"
                      />
                      {otherServicesTranslations[2]?.features?.[3] ??
                        "Fitur custom sesuai kebutuhan"}
                    </li>
                  </ul>
                  <a
          ...
          <div className="grid lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-2">
              <h3 className="font-bold text-lg mb-6">
                {t.footerContactTitle ?? "Kontak Kami"}
              </h3>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <MaterialIcon className="text-sky-500" name="call" />
                  <a
            ...
            <div className="lg:col-span-1">
              <h3 className="font-bold text-lg mb-6">
                {t.footerFollowTitle ?? "Ikuti Kami"}
              </h3>
              <div className="flex flex-col gap-4">
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-gray-700 transition-colors duration-300">
                    <MaterialIcon className="text-lg" name="code" />
                  </div>
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-[#0A66C2] transition-colors duration-300">
                    <MaterialIcon className="text-lg" name="work" />
                  </div>
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-[#E4405F] transition-colors duration-300">
                    <MaterialIcon className="text-lg" name="photo_camera" />
                  </div>
